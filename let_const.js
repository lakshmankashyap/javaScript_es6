...
// This happens because you are attempting to change the reference that person points to, and that is not allowed with const.
...
// because the identifier colors is a constant, and its reference cannot be changed.
colors = []; // TypeError
